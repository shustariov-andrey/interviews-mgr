              ...
              <div className="flex items-center">
                <div className="flex-shrink-0">
                  <div className="h-8 w-8 relative">
                    <Image layout="fill" alt="Workflow" src="https://tailwindui.com/img/logos/workflow-mark-indigo-500.svg"/>
                  </div>
                </div>
              ...
              {menuItems.map((item) => (
                <Disclosure.Button
                  ...
                  className={classNames(
                    item === activeMenuItem ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white',
